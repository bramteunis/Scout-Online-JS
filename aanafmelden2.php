...
<nav class="nav">
    ...
    ?>
		<input type="input" class="form__field" placeholder="Dag" name="dag" id='name' required />
		<input type="input" class="form__field" placeholder="Tijd" name="tijd" id='name2' required />
		<input type="input" class="form__field" placeholder="Activiteit" name="activiteit" id='name3' required />
		<input type="input" class="form__field" placeholder="Organisatoren" name="organisatoren" id='name4' required />
		<input type="input" class="form__field" placeholder="Opmerking" name="opmerking" id='name5'/>
